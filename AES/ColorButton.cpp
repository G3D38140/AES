...
// ColorStatic.cpp, ColorButton.h and Color.h
// Color.h has (#define)'s for different colors (add any color you desire).
//
// Add #include "ColorButton.h" to your Dialogs Header file.
...
void CColorButton::SetBkColor(COLORREF crColor)
{
...
void CColorButton::SetTextColor(COLORREF crColor)
{

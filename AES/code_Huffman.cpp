...
// please, do not remove the copyright sign
static char sign2[] = " simple_Huffman v.3.0 (c) 2010-2012 Jan Mojzis ";
...
int simple_Huffman::CompressFile(char *input, char *output){
	...
	DWORD Size_Cluster = pt_Cluster->Getx8();
	delete pt_Cluster;

	char *inbuffer = new char[Size_Cluster];
	*inbuffer = 0x00;
	char *outbuffer = new char[Size_Cluster];
	*outbuffer = 0x00;
	setvbuf(in,inbuffer, _IOFBF, Size_Cluster);
	setvbuf(out,outbuffer, _IOFBF, Size_Cluster);
	*inbuffer = 0x00;
	initialize();
